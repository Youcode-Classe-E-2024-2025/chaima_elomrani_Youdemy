                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td class="py-3 px-4"><span class="bg-green-100 text-green-800 py-1 px-2 rounded-full text-sm">Published</span></td>
                                    <td class="py-3 px-4">
                                ...
                                <tr>
                                    ...
                                    <td class="py-3 px-4"><span class="bg-yellow-100 text-yellow-800 py-1 px-2 rounded-full text-sm">Draft</span></td>
                                    <td class="py-3 px-4">
                                        <button class="text-blue-500 hover:text-blue-700 mr-2">Edit</button>
                                        <button class="text-red-500 hover:text-red-700">Delete</button>
                                    </td>
