        ...
        <div class="mt-3 text-center">
            ...
            <form id="updateCourseForm" class="mt-2 text-left" action="http://<?= $_SERVER['HTTP_HOST'] ?>/index.php?action=updateCourse" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="courseTitle" name="name" required value="<?= htmlspecialchars($course['title']) ?>"
                ...
                <div id="imageUrlInput" class="mb-4">
                    ...
                    <input type="url" id="courseImage" name="image" value="<?= htmlspecialchars($course['image_path']) ?>"
                ...
                <div id="videoUrlInput" class="mb-4">
                    ...
                    <input type="url" id="courseVideo" name="video" value="<?= htmlspecialchars($course['video_path']) ?>"
                        class="mt-1 py-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-clair-500 focus:ring focus:ring-clair-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                </div>
